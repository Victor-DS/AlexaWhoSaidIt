...
This is a sample template for AlexaWhoSaidIt - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name alexawhosaidit --query 'Stacks[].Outputs'
```
